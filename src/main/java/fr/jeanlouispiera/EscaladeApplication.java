...
public class EscaladeApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u1 = userservice.createUser("Jean", "jeannot@gmail.com");
		User u2 = userservice.createUser("Bob", "bobby@gmail.com");
		User u3 = userservice.createUser("Charles","charlot@yahoo.fr");
		User u4 = userservice.createUser("Charlemagne", "aixlachapelle@yahoo.fr");
		...
		Topo t2 =topoMetier.createTopo("Esacalade en Briançonnais", "Haute Vallée de la Durance et Queyras", "Yann, Martine et Jean-jacques Rolland","2012", 20, 20, "français", 130, TopoStatut.NDIS, u4, s1);
		Topo t3 =topoMetier.createTopo("Valgorge", "site récent", "castelbloc@gmail.com","2010", 15, 30, "français", 250, TopoStatut.NDIS, u2, s2);
		Topo t4= topoMetier.createTopo("Les voies de Sincrista", "Vallées Corses", "Jean-Michel Cambon", "2016", 20, 25, "français/anglais", 125, TopoStatut.DIS, u3, s4);
		Topo t5 =topoMetier.createTopo("Sincrista Valley", "Journey in Corsica", " Roll Kurtz","2006", 25, 25, "english/german", 90, TopoStatut.NDIS, u2, s4);
		Topo t6 =topoMetier.createTopo("Randos sur Tolse", "Versant Nord", "Kolk & Sanders","2019", 15, 30, "français", 250, TopoStatut.NDIS, u1, s3);		
