	 		...
	 		<div class="container col-md-6 col-md-offset-3">
	 			<div class="panel panel-primary ">
				  ...
				  <div class="panel-heading">
					   <h5>Confirmation de la demande de réservation du ${reservation.dateDemande}</h5>
  				...
  				<div class="panel-body">
				   <table class="table table-striped table-condensed table-bordered">
					    ...
					    <tbody>
					         <tr>
					            <td>Propriétaire du Topo :</td>
					            <td>${reservation.topo.user.getUsername()}</td>
					        </tr>
					         <tr>
					            <td>Adresse Mail du Propriétaire :</td>
					            <td>${reservation.topo.user.getAdresseMail()}</td>
					        </tr>
					        <tr>
					            <td>Statut de la demande de Réservation :</td>
