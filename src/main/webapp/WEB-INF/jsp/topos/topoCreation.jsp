...
<div class="container-fluid">
 <div class="row justify-content-center mb-3">
  ...
  <div class="panel panel-primary">
   <div class="panel-heading">Fiche de mise à jour d'un Topo</div>
      ...
      <form:hidden path="codeTopo"/>
       <fieldset class="form-group">
      	...
      	<fieldset class="form-group">
	       ...
	       <form:input path="adresseMailUser" type="text" class="form-control" cols="60"
	        placeholder="OBLIGATOIRE" required="required" />
       ...
       <form:label path="nbPages" class="col-auto col-form-label">Nombre de pages</form:label>
      	...
      	<fieldset class="form-group">
	        ...
	        <fieldset class="form-group">
	        <form:label path="site" class="col-auto col-form-label">Site</form:label>
	      	<form:select path="site">
		     	 <form:option value="-" label="--Choisir un site--"/>
				 <form:options items="${sites}" itemValue="numSite" itemLabel="nomSite" />
	        </form:select>
	       </fieldset>
